...
folder_1hop = 'trajectory_data_1hop_' + dataset_folder
folder_2hop = 'trajectory_data_2hop_' + dataset_folder
...
prefixes = np.array([path[:-2] for path in paths], dtype=object)
np.save(folder_1hop + '/prefixes.npy', prefixes)
